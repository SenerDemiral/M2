...
set TOOLS_PATH=packages\Grpc.Tools.1.14.0\tools\windows_x64
...
%TOOLS_PATH%\protoc.exe --csharp_out Rest  protos/rest.proto --grpc_out Rest --plugin=protoc-gen-grpc=%TOOLS_PATH%\grpc_csharp_plugin.exe
