...
namespace RestClientWinForm
{
    partial class MainDataSet
    {
        ...
        public async Task<string> KPTfill()
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.KPTfill(new QryProxy { Query = "abc" }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
        ...
        public string KPTupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.KPTupdate(request);  // --------->
        ...
        public async Task<string> KDTfill()
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.KDTfill(new QryProxy { Query = "abc" }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
        ...
        public string KDTupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.KDTupdate(request);  // --------->
        ...
        public async Task<string> KDTtreeDownFill()
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.KDTtreeDownFill(new QryProxy { Query = "abc" }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    row = dt.NewRow();
        ...
        public async Task<string> ToKHTfill(ulong P, string Ptyp)
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.ToKHTfill(new QryPproxy { P = P, Ptyp = Ptyp }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
        ...
        public string ToKHTupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.ToKHTupdate(request);  // --------->
        ...
        public async Task<string> ToKDTfill(ulong P)
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.ToKDTfill(new QryPproxy { P = P }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
        ...
        public string ToKDTupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.ToKDTupdate(request);  // --------->
        ...
        public string BRupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.BRupdate(request);  // --------->
        ...
        public async Task<string> NNNfill()
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.NNNfill(new QryProxy { Query = "abc" }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
        ...
        public string NNNupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.NNNupdate(request);  // --------->
        ...
        public async Task<string> NNRfill(ulong P)
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.NNRfill(new PKproxy { PK = P }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
        ...
        public string NNRupdate()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (rs == "A" || rs == "M" || rs == "D")
                {
                    ...
                    var reply = client.NNRupdate(request);  // --------->
        ...
        public async Task<string> NeParentsFill(ulong P)
        {
            ...
            Stopwatch sw = new Stopwatch();
            sw.Start();
            using (var response = client.NeParentsFill(new PKproxy { PK = P }))
            {
                while (await response.ResponseStream.MoveNext(token))
                {
                    //var proxy = response.ResponseStream.Current;
